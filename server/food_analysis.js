...
function findInDB(name) {
  ...
  const aliases = {
    ...
    'овсянк': 'овсянка на воде', 'каша': 'овсянка на воде', 'хлеб': 'хлеб белый',
    ...
    'котлет': 'говядина варёная', 'фарш': 'говядина варёная',
    'яйц': 'яйцо варёное', 'омлет': 'яйцо варёное', 'яичниц': 'яйцо варёное',
